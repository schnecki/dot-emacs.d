...
; (setq shell-file-name "C:/Users/M.SCHNECKENREITHER/AppData/Roaming/emacs-28.2/libexec/emacs/28.2/x86_64-w64-mingw32/cmdproxy.exe")
...
(when (memq system-type '(windows-nt ms-dos))
  ...
  ;; (setq shell-file-name "c:/Program Files/Git/git-cmd.exe")
  ...
  ;; (setq shell-file-name "C:/Program Files/Git/bin/bash.exe")
  (setq shell-file-name "c:/rtools42/usr/bin/bash.exe")
...
;; TAGS
(global-set-key (kbd (concat prefix-command-key " t")) nil)
