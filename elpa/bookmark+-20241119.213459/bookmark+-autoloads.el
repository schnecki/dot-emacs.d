;;; bookmark+-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
;;; Generated autoloads from bookmark+.el
 ...
 (autoload 'bookmark-bmenu-buffer "bookmark+")
 (autoload 'bookmark-plus "bookmark+")
 (autoload 'bmkp-bmenu-buffer "bookmark+")
...
;;; Generated autoloads from bookmark+-1.el
 ...
 (autoload 'bmkp-automatic-bookmark-min-distance "bookmark+")
 (autoload 'bmkp-automatic-bookmark-mode "bookmark+")
 (autoload 'bmkp-automatic-bookmark-mode-delay "bookmark+")
 (autoload 'bmkp-automatic-bookmark-mode-lighter "bookmark+")
 (autoload 'bmkp-automatic-bookmark-set-function "bookmark+")
...
(custom-autoload 'Info-bookmark-use-only-node-not-file-flag "bookmark+-1" t)
 ...
 (autoload 'bmkp-annotate-bookmark-this-file/buffer "bookmark+")
 (autoload 'bmkp-annotate-all-bookmarks-this-file/buffer "bookmark+")
 (autoload 'bmkp-show-this-annotation-read-only "bookmark+")
 (autoload 'bmkp-edit-this-annotation "bookmark+")
 (autoload 'bmkp-copy-bookmark "bookmark+")
 (autoload 'bmkp-clone-bookmark "bookmark+")
 ...
 (autoload 'bmkp-edit-bookmark-record-file/buffer "bookmark+")
 ...
 (autoload 'bmkp-switch-to-bookmark-file-this-file/buffer "bookmark+")
 (autoload 'bmkp-empty-file "bookmark+")
 (autoload 'bmkp-save-bookmarks-this-file/buffer "bookmark+")
 ...
 (autoload 'Info-bookmark-jump "bookmark+")
...
(register-definition-prefixes "bookmark+-1" '("bmk" "bookmark-"))
...
;;; Generated autoloads from bookmark+-bmu.el
 ...
 (autoload 'bmkp-bmenu-show-file-not-buffer-flag "bookmark+")
 ...
 (autoload 'bmkp-bmenu-create/edit-annotations-for-marked "bookmark+")
 ...
 (autoload 'bmkp-copy-bookmark "bookmark+")
 (autoload 'bmkp-bmenu-clone-bookmark "bookmark+")
...
(register-definition-prefixes "bookmark+-bmu" '("bmkp-" "bookmark-bmenu-"))


;;; Generated autoloads from bookmark+-key.el

(register-definition-prefixes "bookmark+-key" '("bmkp-"))
...
;;; Generated autoloads from bookmark+-lit.el
 ...
 (autoload 'bmkp-lighted-here-jump-to-list "bookmark+")
 (autoload 'bmkp-unlight-bookmark "bookmark+")
 (autoload 'bmkp-unlight-bookmark-on-this-line "bookmark+")
 ...
 (autoload 'bmkp-describe-bookmark-lighted-on-this-line "bookmark+")
(register-definition-prefixes "bookmark+-lit" '("bmkp-"))
...
;;; Generated autoloads from bookmark+-mac.el
 ...
 (autoload 'bmkp-make-plain-predicate "bookmark+")
 ...
 (autoload 'bmkp-define-history-variables "bookmark+")
 (autoload 'bmkp-define-type-from-hander "bookmark+")
 (autoload 'bmkp-menu-bar-make-toggle "bookmark+")
 (autoload 'bmkp-with-bookmark-dir "bookmark+")
(register-definition-prefixes "bookmark+-mac" '("bmkp-"))

;;; End of scraped data
