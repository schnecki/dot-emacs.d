...
* Imports a textmate bundle and extracts snippets from `textmate-import-svn-url'" t nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "textmate-to-yas" '("tex" "yas-")))
